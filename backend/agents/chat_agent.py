...
def stream_chat_reply(topic: domain.ResearchTopic, user_message: str, history: List[Dict[str, Any]]):
    """Streams user follow-up questions token-by-token in real time."""
    llm = get_llm()
...
Response:"""
    ...
    try:
        ...
        print(f"Error streaming in chat agent: {e}")
